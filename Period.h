...
#elif PERIOD == 1 && MARKET == 0
const string tag = "TW/H2H";
...
#elif PERIOD == 1 && MARKET == 1
const string tag = "US/H2H";
const int numOfPeriod = 14;
const string trainPeriod[] = {
        "train_2012_Q3-Q4(2012 Q1).csv", "train_2013_Q1-Q2(2013 Q1).csv", "train_2013_Q3-Q4(2013 Q1).csv",
        "train_2014_Q1-Q2(2014 Q1).csv", "train_2014_Q3-Q4(2014 Q1).csv", "train_2015_Q1-Q2(2015 Q1).csv",
        "train_2015_Q3-Q4(2015 Q1).csv", "train_2016_Q1-Q2(2016 Q1).csv", "train_2016_Q3-Q4(2016 Q1).csv",
...
#elif PERIOD == 2 && MARKET == 0
const string tag = "TW/Q2Q";
...
#elif PERIOD == 2 && MARKET == 1
const string tag = "US/Q2Q";
const int numOfPeriod = 28;
const string trainPeriod[] = {
        "train_2012_Q4(2012 Q1).csv", "train_2013_Q1(2013 Q1).csv", "train_2013_Q2(2013 Q1).csv",
        "train_2013_Q3(2013 Q1).csv", "train_2013_Q4(2013 Q1).csv", "train_2014_Q1(2014 Q1).csv",
        "train_2014_Q2(2014 Q1).csv", "train_2014_Q3(2014 Q1).csv", "train_2014_Q4(2014 Q1).csv",
...
#elif PERIOD == 3 && MARKET == 0
const string tag = "TW/M2M";
...
#elif PERIOD == 4 && MARKET == 0
const string tag = "TW/Y2H";
const int numOfPeriod = 16;
const string trainPeriod[] = {
...
#elif PERIOD == 5 && MARKET == 0
const string tag = "TW/Y2Q";
const int numOfPeriod = 32;
const string trainPeriod[] = {
...
const string trainPeriod[] = {
        ...
        "train_2016(2016 Q1).csv", "train_2016_Q2~2017_Q1(2016 Q1).csv",
        "train_2016_Q3~2017_Q2(2016 Q1).csv", "train_2016_Q4~2017_Q3(2016 Q1).csv",
        "train_2017(2017 Q1).csv", "train_2017_Q2~2018_Q1(2017 Q1).csv",
        "train_2017_Q3~2018_Q2(2017 Q1).csv", "train_2017_Q4~2018_Q3(2017 Q1).csv",
        "train_2018(2018 Q1).csv", "train_2018_Q2~2019_Q1(2018 Q1).csv",
        "train_2018_Q3~2019_Q2(2018 Q1).csv", "train_2018_Q4~2019_Q3(2018 Q1).csv"};

#elif PERIOD == 6 && MARKET == 0
const string tag = "TW/Y2M";
...
const string trainPeriod[] = {
        ...
        "train_2016_09~2017_08(2016 Q1).csv", "train_2016_10~2017_09(2016 Q1).csv",
        "train_2016_11~2017_10(2016 Q1).csv", "train_2016_12~2017_11(2016 Q1).csv",
        "train_2017(2017 Q1).csv", "train_2017_02~2018_01(2017 Q1).csv",
        ...
        "train_2017_11~2018_10(2017 Q1).csv", "train_2017_12~2018_11(2017 Q1).csv",
        "train_2018(2018 Q1).csv", "train_2018_02~2019_01(2018 Q1).csv",
        "train_2018_03~2019_02(2018 Q1).csv", "train_2018_04~2019_03(2018 Q1).csv",
        "train_2018_05~2019_04(2018 Q1).csv", "train_2018_06~2019_05(2018 Q1).csv",
        "train_2018_07~2019_06(2018 Q1).csv", "train_2018_08~2019_07(2018 Q1).csv",
        "train_2018_09~2019_08(2018 Q1).csv", "train_2018_10~2019_09(2018 Q1).csv",
        "train_2018_11~2019_10(2018 Q1).csv", "train_2018_12~2019_11(2018 Q1).csv"};

#elif PERIOD == 7 && MARKET == 0
const string tag = "TW/H2Q";
const int numOfPeriod = 32;
const string trainPeriod[] = {
...
const string trainPeriod[] = {
        ...
        "train_2016_Q3-Q4(2016 Q1).csv", "train_2016_Q4~2017_Q1(2016 Q1).csv",
        "train_2017_Q1-Q2(2017 Q1).csv", "train_2017_Q2-Q3(2017 Q1).csv",
        "train_2017_Q3-Q4(2017 Q1).csv", "train_2017_Q4~2018_Q1(2017 Q1).csv",
        "train_2018_Q1-Q2(2018 Q1).csv", "train_2018_Q2-Q3(2018 Q1).csv",
        "train_2018_Q3-Q4(2018 Q1).csv", "train_2018_Q4~2019_Q1(2018 Q1).csv",
        "train_2019_Q1-Q2(2019 Q1).csv", "train_2019_Q2-Q3(2019 Q1).csv"};

#elif PERIOD == 8 && MARKET == 0
const string tag = "TW/H2M";
const int numOfPeriod = 96;
const string trainPeriod[] = {
...
#elif PERIOD == 8 && MARKET == 1
const string tag = "US/H2M";
const int numOfPeriod = 84;
const string trainPeriod[] = {
        "train_2012_07-12(2012 Q1).csv", "train_2012_08~2013_01(2012 Q1).csv",
        "train_2012_09~2013_02(2012 Q1).csv", "train_2012_10~2013_03(2012 Q1).csv",
        "train_2012_11~2013_04(2012 Q1).csv", "train_2012_12~2013_05(2012 Q1).csv", "train_2013_01-06(2013 Q1).csv",
        "train_2013_02-07(2013 Q1).csv", "train_2013_03-08(2013 Q1).csv", "train_2013_04-09(2013 Q1).csv",
        "train_2013_05-10(2013 Q1).csv", "train_2013_06-11(2013 Q1).csv", "train_2013_07-12(2013 Q1).csv",
        ...
        "train_2016_11~2017_04(2016 Q1).csv", "train_2016_12~2017_05(2016 Q1).csv", "train_2017_01-06(2017 Q1).csv",
        "train_2017_02-07(2017 Q1).csv", "train_2017_03-08(2017 Q1).csv", "train_2017_04-09(2017 Q1).csv",
        "train_2017_05-10(2017 Q1).csv", "train_2017_06-11(2017 Q1).csv", "train_2017_07-12(2017 Q1).csv",
        "train_2017_08~2018_01(2017 Q1).csv", "train_2017_09~2018_02(2017 Q1).csv",
        "train_2017_10~2018_03(2017 Q1).csv", "train_2017_11~2018_04(2017 Q1).csv",
        "train_2017_12~2018_05(2017 Q1).csv", "train_2018_01-06(2018 Q1).csv",
        ...
        "train_2018_12~2019_05(2018 Q1).csv", "train_2019_01-06(2019 Q1).csv",
        "train_2019_02-07(2019 Q1).csv", "train_2019_03-08(2019 Q1).csv", "train_2019_04-09(2019 Q1).csv",
        "train_2019_05-10(2019 Q1).csv", "train_2019_06-11(2019 Q1).csv"};

#elif PERIOD == 9 && MARKET == 0
const string tag = "TW/Q2M";
const int numOfPeriod = 96;
const string trainPeriod[] = {
...
#elif PERIOD == 10 && MARKET == 0
const string tag = "TW/H#";
const int numOfPeriod = 16;
const string trainPeriod[] = {
...
#elif PERIOD == 11 && MARKET == 0
const string tag = "TW/Q#";
const int numOfPeriod = 32;
const string trainPeriod[] = {
...
const string trainPeriod[] = {
        ...
        "train_2016_Q1(2016 Q1).csv", "train_2016_Q2(2016 Q1).csv",
        "train_2016_Q3(2016 Q1).csv", "train_2016_Q4(2016 Q1).csv",
        "train_2017_Q1(2017 Q1).csv", "train_2017_Q2(2017 Q1).csv",
        "train_2017_Q3(2017 Q1).csv", "train_2017_Q4(2017 Q1).csv",
        "train_2018_Q1(2018 Q1).csv", "train_2018_Q2(2018 Q1).csv",
        "train_2018_Q3(2018 Q1).csv", "train_2018_Q4(2018 Q1).csv"};

#elif PERIOD == 12 && MARKET == 0
const string tag = "TW/M#";
const int numOfPeriod = 96;
const string trainPeriod[] = {
